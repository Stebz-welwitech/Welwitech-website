...
export function Expertise() {
    ...
    return (
        <section id="expertise" className="py-16 md:py-24 lg:py-32 bg-white border-t border-zinc-100">
            <div className="container mx-auto px-4 sm:px-6 max-w-[1400px]">
                <div className="mb-12 md:mb-16 lg:mb-20">
                    ...
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-black max-w-2xl leading-tight">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 border-t border-l border-zinc-100">
                    {items.map((item, idx) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="group p-6 sm:p-8 md:p-10 border-r border-b border-zinc-100 bg-white hover:bg-zinc-50 transition-colors duration-300 relative"
                        >
                            <div className="w-12 h-12 bg-zinc-50 rounded-lg flex items-center justify-center mb-6 md:mb-8 text-black group-hover:bg-black group-hover:text-white transition-colors duration-300">
                                <item.icon className="w-5 h-5" />
                            </div>
                            <h3 className="text-lg sm:text-xl font-bold text-black mb-4 sm:mb-6">{item.title}</h3>
