...
export function CinematicHero({
  ...
  cardHeading = "Design. Mobile. Web. IA.",
  cardDescription = <><span className="text-white font-semibold">Welwitech</span> accompagne entreprises et startups dans la conception, le développement et l'optimisation de leurs produits digitaux — depuis Dubai.</>,
  metricValue = 50,
  metricLabel = "Projets",
  ctaHeading = "Démarrons ensemble.",
  ctaDescription = "Contactez-nous pour un premier échange sans engagement. Notre équipe est prête à transformer vos idées.",
  className,
  ...props
} = {}) {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      scrollTl
        ...
        .to(".progress-ring", { strokeDashoffset: 52, duration: 2, ease: "power3.inOut" }, "-=1.2")
    ...
    >
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <a href="mailto:contact@welwitech.com" className="btn-modern-light flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-500 uppercase mb-[-2px]">Contactez-nous</div>
              <div className="text-lg font-bold leading-none tracking-tight">Par email</div>
            </div>
          </a>
          <a href="#services" className="btn-modern-dark flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group"
            ...
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-400 uppercase mb-[-2px]">Découvrir</div>
              <div className="text-lg font-bold leading-none tracking-tight">Nos services</div>
            </div>
          </a>
        </div>
      </div>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                <div ref={mockupRef} className="relative w-[280px] h-[580px] rounded-[3rem] iphone-bezel flex flex-col will-change-transform" style={{ transformStyle: "preserve-3d" }}>
                  ...
                  <div className="absolute inset-[7px] bg-[#050914] rounded-[2.5rem] overflow-hidden shadow-[inset_0_0_15px_rgba(0,0,0,1)] text-white z-10">
                    ...
                    <div className="relative w-full h-full pt-10 px-4 pb-6 flex flex-col overflow-hidden">
                      <div className="phone-widget flex justify-between items-center mb-5">
                        <div className="flex flex-col">
                          <span className="text-[9px] text-neutral-500 uppercase tracking-widest font-bold">Dashboard</span>
                          <span className="text-lg font-bold tracking-tight text-white">Welwitech</span>
                        </div>
                        <div className="w-8 h-8 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-xs border border-white/10">W</div>
                      </div>
                      <div className="phone-widget relative w-36 h-36 mx-auto flex items-center justify-center mb-5 drop-shadow-[0_10px_20px_rgba(0,0,0,0.8)]">
                      ...
                      <div className="space-y-2 flex-1">
                        <div className="phone-widget widget-depth rounded-xl p-2.5 flex items-center">
                          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500/20 to-blue-600/5 flex items-center justify-center mr-2.5 border border-blue-400/20">
                          ...
                          <div className="flex-1">
                            <div className="h-1.5 w-16 bg-neutral-300/80 rounded-full mb-1.5" />
                            <div className="h-1 w-10 bg-neutral-600 rounded-full" />
                          </div>
                        </div>
                        <div className="phone-widget widget-depth rounded-xl p-2.5 flex items-center">
                          ...
                          <div className="flex-1">
                            <div className="h-1.5 w-14 bg-neutral-300/80 rounded-full mb-1.5" />
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">50+ Projets</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Livrés avec succès</p>
                  </div>
                </div>
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Dubai, UAE</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Studio basé à Dubai</p>
                  </div>
                </div>
              </div>
            </div>
