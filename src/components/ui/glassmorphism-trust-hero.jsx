...
const CLIENTS = [
  { name: "Startups", icon: Hexagon },
  { name: "PME", icon: Triangle },
  { name: "Enterprises", icon: Command },
  { name: "E-commerce", icon: Ghost },
  { name: "SaaS", icon: Gem },
...
export default function GlassmorphismTrustHero() {
  ...
  return (
    <div className="relative w-full bg-zinc-950 text-white overflow-hidden font-sans" id="hero">
      <style>{`
      ...
      {/* Content wrapper — flex centering for full viewport height */}
      <div className="relative z-10 flex items-center min-h-screen">
        <div className="mx-auto max-w-7xl w-full px-6 py-20 sm:px-10 md:py-24 lg:px-16">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-6 flex flex-col justify-center space-y-8">
              ...
              <p className="animate-fade-in delay-300 max-w-xl text-lg text-zinc-400 leading-relaxed">
                Design, développement mobile &amp; web, intelligence artificielle &mdash;
                nous accompagnons votre vision de l'idée au lancement, depuis Dubai.
              </p>
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-zinc-400">Projets livrés</div>
                    </div>
                  </div>

                  <div className="space-y-3 mb-8">
                    <div className="flex justify-between text-sm">
                      <span className="text-zinc-400">Satisfaction client</span>
                  ...
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <StatItem value="4" label="Pôles" />
                    <StatItem value="24/7" label="Support" />
                    <StatItem value="100%" label="Qualité" />
                  </div>
